...
android {
    namespace = "com.example.yumpty"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.yumpty"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui:1.0.7")
    implementation("androidx.compose.material:material:1.0.7")
    implementation("androidx.compose.ui:ui-tooling:1.0.7")
